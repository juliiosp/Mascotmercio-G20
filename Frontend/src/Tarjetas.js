...
const Tarjetas = () => {
  return (
    <div className="container-card">
      <div className="card">
        <img src={"perro.jpg"} alt="Perro corriendo" className="card-image" />
        <div className="text">
      ...
      <div className="card">
        <img src={"etsit.jpg"} alt="Universidad UPM" className="card-image" />
        <div className="text">
      ...
      <div className="card">
        <img src={"CentroComercial.jpg"} alt="Centro comercial" className="card-image" />
        <div className="text">
